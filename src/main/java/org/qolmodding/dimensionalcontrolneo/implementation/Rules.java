...
import org.qolmodding.dimensionalcontrolneo.helpers.ResourceLocationHelpers;
...
public class Rules
{
    ...
    private static void parseRuleArray(RegistryAccess registryAccess, Rule.Type ruleType)
    {
        JsonArray rulesJsonArray = switch (ruleType)
        {
            ...
            case ENTITY -> unparsedEntityRules;
            case LOOT -> unparsedLootRules;
        };
