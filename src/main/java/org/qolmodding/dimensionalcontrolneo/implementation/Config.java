...
public class Config
{
    ...
    private static final BooleanValue LOG_ALLOWED_STRUCTURE = BUILDER
            .comment("Enable logging of allowed structures. This is off by default.")
            .define("log-allowed-structures", false);

    private static final BooleanValue LOG_PREVENTED_STRUCTURE = BUILDER
            .comment("Enable logging of prevented structures. This is on by default. If you use this on a server and don't want to waste space with constant spam turn it off.")
            .define("log-prevented-structures", true);

    private static final BooleanValue LOG_ALLOWED_STRUCTURE_POOL_ELEMENT = BUILDER
    ...
    private static final BooleanValue LOG_PREVENTED_STRUCTURE_POOL_ELEMENT = BUILDER
            .comment("Enable logging of prevented structure pool elements. This is on by default. If you use this on a server and don't want to waste space with constant spam turn it off.")
            .define("log-prevented-structure-pool-elements", true);

    private static final BooleanValue LOG_ALLOWED_FEATURE = BUILDER
            .comment("Enable logging of allowed environmental features. This is off by default.")
            .define("log-allowed-features", false);

    private static final BooleanValue LOG_PREVENTED_FEATURE = BUILDER
            .comment("Enable logging of prevented environmental features. This is on by default. If you use this on a server and don't want to waste space with constant spam turn it off.")
            .define("log-prevented-features", true);

    private static final BooleanValue LOG_ALLOWED_ENTITY = BUILDER
            .comment("Enable logging of allowed entity spawns. This is off by default.")
            .define("log-allowed-entities", false);

    private static final BooleanValue LOG_PREVENTED_ENTITY = BUILDER
            .comment("Enable logging of prevented entity spawns. This is on by default. If you use this on a server and don't want to waste space with constant spam turn it off.")
            .define("log-prevented-entities", true);

    private static final BooleanValue LOG_ALLOWED_LOOT = BUILDER
            .comment("Enable logging of allowed loot items. This is off by default.")
            .define("log-allowed-loot", false);

    private static final BooleanValue LOG_PREVENTED_LOOT = BUILDER
            .comment("Enable logging of prevented loot items. This is on by default. If you use this on a server and don't want to waste space with constant spam turn it off.")
            .define("log-prevented-loot", true);

    private static final BooleanValue DEBUG = BUILDER
            .comment("Enable debug logging. This is on by default. If you use this on a server and don't want to waste space with constant spam turn it off.")
            .define("debug", true);
